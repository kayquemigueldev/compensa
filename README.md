...
![JavaFX](https://img.shields.io/badge/JavaFX-21.0.6-2C54CB?style=for-the-badge)
...
![JUnit](https://img.shields.io/badge/JUnit_5-Testes-25A162?style=for-the-badge&logo=junit5&logoColor=white)
![Version](https://img.shields.io/badge/Versão-1.0.0-8EEA3C?style=for-the-badge)
![Platform](https://img.shields.io/badge/Desktop-Windows%20%7C%20macOS-555555?style=for-the-badge)
...
<p align="center">
    <img src="docs/screenshots/dashboard.png"
         alt="Dashboard do Compensa?"
         width="900">
</p>

<p align="center">
    <img src="docs/screenshots/purchase-analysis.png"
         alt="Análise de compra no Compensa?"
         width="900">
</p>

<p align="center">
    <img src="docs/screenshots/savings-goal.png"
         alt="Objetivo financeiro no Compensa?"
         width="900">
</p>
...
```mermaid
flowchart TD
    A[Configurar perfil] --> B[Informar compra]
    B --> C[Calcular impactos]
    C --> D[Apresentar recomendação]
    D --> E{Decisão}
    E -->|Comprar| F[Registrar compra]
    E -->|Esperar| G[Registrar pendência]
    E -->|Não comprar| H[Registrar valor preservado]
    F --> I[Dashboard e insights]
    G --> I
    H --> I
```
...
[![GitHub](https://img.shields.io/badge/GitHub-kayquemigueldev-181717?style=for-the-badge&logo=github)](https://github.com/kayquemigueldev)
